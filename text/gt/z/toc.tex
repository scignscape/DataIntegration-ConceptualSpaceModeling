...
\contentsline {subsection}{\numberline {3.3.1}Customizing Clinical Trial Management Software}{5}

\contentsline {subsubsection}{\numberline {3.3.1.1}Toward Fine-Grained Sociodemographic Models}{6}
...
\contentsline {subsection}{\numberline {3.3.2}Representing Trial Data via Object Models}{8}


\contentsline {section}{\numberline {3.4}Text and Data Mining via CORD-19}{8}
\contentsline {subsection}{\numberline {3.4.1}Overview of CORD-19}{9}
