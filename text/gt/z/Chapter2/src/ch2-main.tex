...
\p{Our goal in this first chapter is to establish some basic ideas 
as a precursor to more in-depth analysis, whereas 
later chapters will examine issues of 
...
from new biomedical technologies.}
...
we adopt Covid-19 as a lenss for examining the 
